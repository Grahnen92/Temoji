...
namespace UnityStandardAssets.ImageEffects
{
    ...
    public class MyDepthOfField : PostEffectsBase {
        ...
        private float focalLength = 10.0f;
        ...
        void OnRenderImage (RenderTexture source, RenderTexture destination) {
            ...
            Player = GameObject.Find("final_prototype_neckjoint");
            focalLength = (transform.position - Player.transform.position).magnitude;
